...
import { ActiveSectionContext } from "./ActiveSectionContextProvider";
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        rounded-none border border-white dark:bg-gray-950 dark:border-black/40 
        dark:bg-opacity-75 border-opacity-40 bg-white bg-opacity-80 
...
export function useActiveSectionContext() {
  const constext = useContext(ActiveSectionContext);
  if (constext === null) {
    throw new Error(
